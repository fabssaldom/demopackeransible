...
module "project" {
  source          = "github.com/fabssaldom/sie-iac-fabric-modules/project"
  name            = var.project_id
...
module "service-account-image-builder" {
  source     = "github.com/fabssaldom/sie-iac-fabric-modules/iam-service-account"
...
module "vpc" {
  source     = "github.com/fabssaldom/sie-iac-fabric-modules/net-vpc"
  project_id = module.project.project_id
  name       = "image-builder"
  subnets = [
    {
...
module "firewall" {
  source     = "github.com/fabssaldom/sie-iac-fabric-modules/net-vpc-firewall"
  project_id = module.project.project_id
...
module "nat" {
  source                = "github.com/fabssaldom/sie-iac-fabric-modules/net-cloudnat"
  project_id            = module.project.project_id
  region                = var.region
  name                  = "default"
